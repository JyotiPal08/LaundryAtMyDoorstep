           ...
           <CardBody>
            <Form onSubmit={this.submitHandler}>
             <FormGroup>
               ...
               <Input type='text' required placeholder='Enter here' name="admin_name" id='admin_name' onChange={this.handleChange} value={admin_name}></Input>
             </FormGroup>
             <FormGroup>
               <Label for="admin_emailid">Enter EmailId</Label>
               <Input type='email' required placeholder='Enter here' name="admin_emailid" id='admin_emailid' onChange={this.handleChange} value={admin_emailid}></Input>
             </FormGroup>
             <FormGroup>
               <Label for="admin_number">Enter your Contact Number</Label>
               <Input type='number' required placeholder='Enter number here' name="admin_number" id='admin_number' onChange={this.handleChange} value={admin_number}></Input>
             </FormGroup>
             
             <FormGroup>
               <Label for="admin_address">Enter your Address here</Label>
               <Input type='text' required placeholder='Enter here' name="admin_address" id='admin_address' onChange={this.handleChange} value={admin_address}></Input>
             </FormGroup>
             <FormGroup>
               <Label for="admin_disc">Enter description for your shop</Label>
               <Input bsSize="lg" required placeholder='Enter here' name="admin_disc" id='admin_disc' onChange={this.handleChange} value={admin_disc} type="textarea"/>
             </FormGroup>
             <FormGroup>
               <Label for="admin_password">Enter Password</Label>
               <Input type='password' required placeholder='Enter password here' name="admin_password" id='admin_password' onChange={this.handleChange} value={admin_password}></Input>
             </FormGroup>
